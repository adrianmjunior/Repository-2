...
if ( ! function_exists( 'portfolio_wordpress_setup' ) ) :
	...
	function portfolio_wordpress_setup() {
		 ...
		 * If you're building a theme based on Portfolio wordpress, use a find and replace
		 * to change 'portfolio-wordpress' to the name of your theme in all the template files.
		 */
...
function new_excerpt_more($more) {
       global $post;
	return '<a class="moretag" href="'. get_permalink($post->ID) . '"><button type="button" class="btn btn-info">Read More</button></a>';
}
